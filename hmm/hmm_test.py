...
sequence = pd.read_csv("hmm_data/hmm_data_best_strategies_part156.csv")
...
with open(f"hmm_results/best_model_states_{n_components}_part{n_participants}.pkl", "wb") as file:
